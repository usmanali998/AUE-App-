...
class ChangeNumberVerificationScreen extends StatefulWidget {
  final String studentId;
  final String newPhoneNumber;

  ChangeNumberVerificationScreen({@required this.studentId, @required this.newPhoneNumber});

  @override
  _ChangeNumberVerificationScreenState createState() => _ChangeNumberVerificationScreenState();
}

class _ChangeNumberVerificationScreenState extends State<ChangeNumberVerificationScreen> {
                  ...
                  return PrimaryButton(
                    ...
                    onTap: () async {
                      if (notifier.isOTPVerified && validator() == null) {
                        await notifier.changePhoneNumber(widget.studentId, widget.newPhoneNumber);
                        Get.offAll(TabsView());
