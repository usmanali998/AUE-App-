...
//
//     final grantDetailsSemester = grantDetailsSemesterFromJson(jsonString);

import 'dart:convert';

GrantDetailsSemester grantDetailsSemesterFromJson(String str) => GrantDetailsSemester.fromJson(json.decode(str));

String grantDetailsSemesterToJson(GrantDetailsSemester data) => json.encode(data.toJson());

class GrantDetailsSemester {
  GrantDetailsSemester({
    this.details,
    this.semesterList,
  });
  ...
  factory GrantDetailsSemester.fromJson(Map<String, dynamic> json) => GrantDetailsSemester(
