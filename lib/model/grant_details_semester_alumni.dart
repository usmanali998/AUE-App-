...
//
//     final grantDetailsSemesterAlumni = grantDetailsSemesterAlumniFromJson(jsonString);

import 'dart:convert';

import 'grant_details_semester.dart';

GrantDetailsSemesterAlumni grantDetailsSemesterAlumniFromJson(String str) => GrantDetailsSemesterAlumni.fromJson(json.decode(str));

String grantDetailsSemesterAlumniToJson(GrantDetailsSemesterAlumni data) => json.encode(data.toJson());

class GrantDetailsSemesterAlumni {
  GrantDetailsSemesterAlumni({
    this.details,
    this.semesterList,
  });
  ...
  factory GrantDetailsSemesterAlumni.fromJson(Map<String, dynamic> json) => GrantDetailsSemesterAlumni(
